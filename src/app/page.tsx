  ...
  return (
    <div className="min-h-screen bg-gray-700 flex items-center justify-center p-4">
      <div className="p-2 rounded-3xl bg-gradient-to-br from-gray-300 to-black shadow-2xl">
        <div className="relative max-w-[35rem] max-h-[28rem] bg-gradient-to-b from-neutral-900 from-0% via-orange-600 via-25% to-neutral-900 to-50% rounded-2xl p-8 flex flex-col items-center justify-center text-white overflow-hidden">
          ...
          <div className="text-center mb-2 relative z-10">
            <h1 className="text-2xl md:text-4xl font-light mb-4 tracking-widest leading-relaxed">
              48-Hour Updates
            </h1>
